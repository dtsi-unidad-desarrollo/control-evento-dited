       ...
       <a type="button" class="text-warning" data-bs-toggle="modal"
           data-bs-target="#modalformularioEditarComensal{{ $event->id }}">
           <i class="bi bi-pencil fs-4"></i>
       </a>

       <!-- Modal formulario crear estudiante -->
       <div class="modal fade text-start" id="modalformularioEditarComensal{{ $event->id }}" data-bs-backdrop="static"
                   ...
                   <div class="modal-body">
                       <form action="{{ route('eventos.update', $event->id) }}" method="POST"
                           ...
                           <div class="col-12 text-center">
                               @if ($event->foto)
                                   <img src="{{ asset($event->foto) }}" alt="foto">
                               @else
                           ...
                           <div class="col-xs-12 col-sm-6">
                               ...
                               <div class="input-group has-validation">
                                   ...
                                   <input type="text" name="nombres" class="form-control" id="yourUsername"
                                       ...
                                       value="{{ old('nombres') ?? $event->nombres }}" required>
                           ...
                           <div class="col-xs-12 col-sm-6">
                               ...
                               <div class="input-group has-validation">
                                   ...
                                   <input type="text" name="apellidos" class="form-control" id="yourUsername"
                                       ...
                                       value="{{ old('apellidos') ?? $event->apellidos }}" required>
                           ...
                           <div class="col-xs-12 col-sm-4">
                               ...
                               <select name="nacionalidad" class="form-select" id="validationCustom04" required>
                                   ...
                                   @endif
                                   @if ($event->nacionalidad)
                                       <option value="{{ $event->nacionalidad }}" selected>
                                           {{ old('nacionalidad') ?? $event->nacionalidad }}
                                       </option>
                                   @endif
                           ...
                           <div class="col-xs-12 col-sm-4">
                               ...
                               <div class="input-group">
                                   <input type="text" name="cedula" class="form-control bg-muted inputCedula"
                                       id="{{ $event->cedula }}" placeholder="Ingrese cédula"
                                       value="{{ old('cedula') ?? $event->cedula }}" disabled readonly required>
                               ...
                               <div class="form-check form-switch">
                                   <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                                       value="1" name="estatus" {{ $event->estatus ? 'checked' : '' }}>
                                   <label class="form-check-label"
                                       for="flexSwitchCheckChecked">{{ $event->estatus ? 'ACTIVO' : 'INACTIVO' }}</label>
                               </div>
                           ...
                           <div class="col-xs-12 col-sm-4">
                               ...
                               <select name="sexo" class="form-select" id="validationCustom04" required>
                                   ...
                                   @endif
                                   @if ($event->sexo)
                                       <option value="{{ $event->sexo }}" selected>
                                           {{ $event->sexo }}
                                       </option>
                                   @endif
                           ...
                           <div class="col-xs-12 col-sm-6">
                               ...
                               <select name="tipo_comensal" class="form-select" id="validationCustom04" required>
                                   ...
                                   @else
                                       <option value="{{ $event->tipo_comensal }}" selected>
                                           {{ $event->tipo_comensal }}
                                       </option>
                                   @endif
                           ...
                           <div class="col-xs-12 col-sm-12">
                               ...
                               <div class="input-group">
                                   ...
                                   <textarea class="form-control" aria-label="With textarea" name="observacion" minlength="15" maxlength="500">
                                     {{ old('observacion') ?? $event->observacion }}
                                 </textarea>
                               </div>
