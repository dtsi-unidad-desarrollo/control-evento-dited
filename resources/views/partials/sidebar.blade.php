    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav-10"
                ...
                <!-- Start Components Nav | Eventos -->
                <li class="nav-item">
                    <a class="nav-link {{ url()->current() == route('eventos.index') ? 'bg-primary text-white' : 'collapsed' }}"
                      href="{{ route('eventos.index') }}">
                        <i class="bi bi-shield-lock fs-3"></i><span>Eventos</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                </li><!-- End Nav | Eventos -->
